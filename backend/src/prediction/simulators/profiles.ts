...
const PROFILES: Record<string, SportSimulationProfile> = {
  ...
  TENNIS: {
    sport: "TENNIS",
    engineLabel: "Tennis set/match-format model",
    scoringUnit: "sets",
    baseline: { total: 2.45, totalMin: 2.0, totalMax: 3.0, marginSd: 0.85, totalSd: 0.45, minScore: 0, granularity: 1 },
    marginPer100Elo: 0.55,
    ratingPriorBlendWithScoreBaseline: 0.35,
    ratingPriorBlendWithoutScoreBaseline: 1,
    meaningfulMarginThreshold: 0.08,
    minMean: 0.15,
    netRatingShiftDivisor: 70,
    netRatingShiftCap: 0.6,
    trendMarginMultiplier: 0.9,
    trendMarginCap: 0.6,
    venueSplitMultiplier: 0.8,
    venueSplitCap: 0.5,
