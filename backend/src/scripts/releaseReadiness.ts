...
const checks: Check[] = [
  ...
  { key: "APPLE_CLIENT_ID", required: true, note: "Sign in with Apple token validation and revocation" },
  { key: "APPLE_APP_BUNDLE_IDENTIFIER", required: true, note: "native iOS Apple identity-token audience" },
