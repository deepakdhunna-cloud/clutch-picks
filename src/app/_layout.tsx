    ...
    >
      <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
        ...
        <Stack screenOptions={{ headerShown: false, animation: 'ios_from_right', animationDuration: 200, gestureEnabled: true, fullScreenGestureEnabled: false }}>
          ...
          <Stack.Screen name="user/[id]" options={{ freezeOnBlur: true, fullScreenGestureEnabled: true }} />
          <Stack.Screen name="followers/[userId]" options={{ freezeOnBlur: true, fullScreenGestureEnabled: true }} />
